...
summary(churn_data) # checking for summary of the data frame after removing the customer_if field
```
We are making analysis for each customer,Hence customer_id was irrelevant field in the data set so we decided to remove the customer_id column from the data frame.
...
ttestcreditscore95 = t.test(churn_balance_sample$credit_score) # default conf.level = 0.95
ttestcreditscore95
ttestcreditscore99 = t.test(churn_balance_sample$credit_score, conf.level=0.99 )
ttestcreditscore99
ttestcreditscore50 = t.test(churn_balance_sample$credit_score,  conf.level=0.50 )
ttestcreditscore50

ttestcreditscore95$conf.int
ttestcreditscore99$conf.int
ttestcreditscore50$conf.int
```
