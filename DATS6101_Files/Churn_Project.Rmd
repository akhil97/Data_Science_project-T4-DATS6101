...
```{r}
reg.churnback <- regsubsets(churn~.-customer_id, data = churn_data_pc, method = "backward", nvmax = 9, nbest = 1)
...
```{r}
reg.churnseqrep <- regsubsets(churn~.-customer_id, data =churn_data_pc, nvmax = 9, nbest = 1 , method = "seqrep")
