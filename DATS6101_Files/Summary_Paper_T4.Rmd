...
**Active Status** Out of Active customers (51.51% of sample population) only 14.26% customers are churned. Whereas, 26.85% Inactive customers are churned (48.49% of sample population). The chi-squared test we performed confirms there is a statistically significant correlation to suggest that active status and customer attrition are not independent variables. As mentioned in Chapter 2 Limitations, a vague definition of "Active" was provided, and we are not able to pinpoint what exactly deems a customer 'inactive". Resultant, any conclusions drawn from tests on this variable are

**Country** In France, around 16.15% of consumers churned on this, compared to 16.67% in Spain. Germany, on the other hand, has the greatest churn rate (about 32.44%), which is more than double that of France and Spain. As a result, as compared to clients from France and Spain, the majority of German customers are set to churn.
