...
ggplot(data=churn_data,aes(x=tenure,fill=churn))+
  ...
  labs(title = "Tenure with Bank vs Churn",x="Account Age (Years)",y="Churn")+
  theme_minimal()
```
...
Topre, G. (2022, August 30). Bank Customer Churn Dataset. Kaggle. Retrieved October 4, 2022, from https://www.kaggle.com/datasets/gauravtopre/bank-customer-churn-dataset 
