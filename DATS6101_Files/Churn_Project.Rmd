...
churn_data$churn[churn_data$churn== "Churn"]<-1
churn_data$churn[churn_data$churn== "No Churn"]<-0
...
cs_churn <- table(churn_data$age, churn_data$churn)
cs_churn

cor_scores_age <- cor(churn_data_numeric$age, churn_data_numeric$churn)
cor_scores_age
```
