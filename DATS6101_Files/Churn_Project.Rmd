...
```{r Chisq test of independence between Age and customer churn rate}
#Contingency table
contab_age = table(churn_data$churn, churn_data$age)
xkabledply(contab_age, title="Contingency table for Age vs Churn (0 or 1)")

#Chisquare Test of independency
chichurn_age = chisq.test(contab_age)
chichurn_age
