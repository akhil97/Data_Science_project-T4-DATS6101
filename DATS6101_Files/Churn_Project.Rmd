...
summary(churnglm4)
xkabledply( confusion_matrix(churnglm4), title = "Confusion matrix from Logit Model-5" )
...
summary(churnglm5)
xkabledply( confusion_matrix(churnglm5), title = "Confusion matrix from Logit Model-6" )
