...
### Determine whether age,gender and country predict the churn rate uisng linear regression model.
```{r  results='markup'}
...
### Determine whether products,account status predict the churn rate uisng linear regression model.
...
### To determine the effects of churn rate we run full model using logit regression model.
```{r results='markup'}
