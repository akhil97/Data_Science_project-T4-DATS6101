...
cor_scores_balance <- cor(churn_data_numeric$credit_score, churn_data_numeric$churn)
cor_scores_balance
```
...
ggplot(data=churn_data,aes(x=country,fill=churn))+
  geom_bar(col="black")+
  scale_fill_manual('Position', values=c('red', 'lightblue')) +
  labs(title = "Country vs Churn",x="Country",y="Chrun")+
  theme_minimal()
``` 
...
### Does churn depends on age of the customers?
